...
/*struct TrainingTestView: View {
    ...
    var body: some View {
        ...
        .fullScreenCover(isPresented: $navigateToRealTest) {
            RealTestStartView(userId: Int, phoneId: Int)
...
struct TrainingTestView: View {
    ...
    var body: some View {
        ...
        .navigationBarBackButtonHidden(true)
        .fullScreenCover(isPresented: $navigateToRealTest) {
            RealTestStartView(userId: userId, phoneId: phoneId) // ✅ Correction ici
        }
        .onAppear {
            availableFeedbackTypes = Array(feedbackTypes.keys).shuffled()
        }
...
struct TrainingTestView_Previews: PreviewProvider {
    static var previews: some View {
        TrainingTestView(userId: 1, phoneId: 1) // ✅ Correction ici
    }
}
